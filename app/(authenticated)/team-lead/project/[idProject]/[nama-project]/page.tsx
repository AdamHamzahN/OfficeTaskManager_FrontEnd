            ...
            <Row className="content-center w-full mb-4 justify-between">
                ...
                <div>
                    {(status_project !== 'done' && status_project !== 'approved') && (
                        ...
                        >
                            <button
                                className="bg-[#1890ff] hover:bg-blue-700 text-white py-2 px-2 border border-blue-700 rounded cursor-pointer"
            ...
            <Row className="content-center w-full mb-4 justify-between mt-5">
                ...
                <div>
                    {(status_project !== 'done' && status_project !== 'approved') && (
                        ...
                        >
                            <button className="bg-[#1890ff] hover:bg-blue-700 text-white py-2 px-2 border border-blue-700 rounded cursor-pointer"
                                onClick={() => {
                                    setFormData({
                                        nama_tugas: '',
                                        deskripsi_tugas: '',
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                ...
                <div style={{ display: 'flex', gap: 20, fontFamily: 'Arial', marginTop: 5, marginBottom: 5 }}>
                    ...
                    {detailProject?.data.status !== 'approved' && (
                        ...
                        >
                            <button type="button"
                                className="bg-transparent hover:bg-blue-500 text-blue-700 hover:text-white py-3 px-6 border border-blue-500 hover:border-transparent rounded cursor-pointer"

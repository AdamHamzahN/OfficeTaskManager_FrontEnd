...
const ModalDetailJobs: React.FC<{idJobs: string}> = ({idJobs}) => {

    const { data: detailJob, error, isValidating: loading } = jobsRepository.hooks.useGetJobById(idJobs);
    ...
    return (
        <div style={{ borderTop: '2px ' }}>
            ...
            <Input value={detailJob.data.results.user.nama} readOnly style={{ marginBottom: '16px' }} />
